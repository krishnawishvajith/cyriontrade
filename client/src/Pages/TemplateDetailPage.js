...
const TemplateDetailPage = () => {
  ...
  useEffect(() => {
    // Find the template from Templates category
    const templates = MARKETPLACE_ITEMS["Templates"] || [];
    ...
    if (foundTemplate) {
      setTemplate({
        ...foundTemplate,
        type: "Template",
        rating: foundTemplate.rating || 5,
        reviews: foundTemplate.reviews || 0,
        description: `This is a comprehensive ${foundTemplate.title} designed to help you get started with trading quickly and efficiently.\n\nKey Features:\n• Easy to use and customize\n• Pre-configured settings\n• Suitable for beginners and advanced traders\n• Regular updates and support\n\nThis template includes all the essential tools and configurations you need to start trading effectively.`,
      });
    } else {
        ...
        <div className={classes.layout}>
          ...
          <div className={classes.sidebar}>
            <div className={classes.sidebarHeader}>
              <div className={classes.sidebarTitle}>{template.title}</div>
          ...
          <div className={classes.mainContent}>
            <div className={classes.banner}>
              {template.image ? (
                ...
                <span style={{ fontSize: "6rem" }}>{template.emoji}</span>
              )}
            </div>
                ...
                <div>
                  ...
                  {template.badge && (
                    <div className={classes.badge}>
                      {template.badge === "HIGH WIN RATE" && <TrendingUp style={{ fontSize: "14px" }} />}
                      {template.badge === "AI CONFIRMATION" && <VerifiedUser style={{ fontSize: "14px" }} />}
                      {template.badge === "POPULAR" && <Star style={{ fontSize: "14px" }} />}
                      {template.badge}
                    </div>
                  )}
